import '../classModel/Fix_Address_DistrictArea.dart';
import 'dart:io';
...
class bllFix_Address_DistrictArea {
  static List<String> ColumnsName = enTable_Fix_Address_DistrictArea.values.map((item) => item.name).toList();
  static late List<Fix_Address_DistrictArea> lstFix_Address_DistrictArea = [];
  static late Fix_Address_DistrictArea itemFix_Address_DistrictArea;
  static String query = '';
...
//**************************** general function ****************************
  ...
  static Future<int> getMaxID_firestore() async {
    ...
    await FirebaseFirestore.instance
        .collection(en_TablesName.Fix_Address_DistrictArea.name)
        .orderBy(enTable_Fix_Address_DistrictArea.ID.name, descending: true)
        .limit(1)
        .get()
        .then((value) {
      if (value.docs.isEmpty) {
        ...
        maxID = value.docs.first.get(enTable_Fix_Address_DistrictArea.ID.name);
        maxID += 1;
      }
    }).catchError((error) {
  ...
  static Future<int> getMax_firestore(enTable_Fix_Address_DistrictArea colName, {BLLCondions? condion}) async {
    int maxID = 1;
...
//**************************** add & set ****************************
  ...
  static Future<String> fire_AddItem(Fix_Address_DistrictArea itemFix_Address_DistrictArea) async {
    String docCreatedName = '';
    await FirebaseFirestore.instance.collection(en_TablesName.Fix_Address_DistrictArea.name).add(itemFix_Address_DistrictArea.toMap()).then((val) {
  ...
  static Future<bool> fire_SetItemMap(String docName, Map<String, dynamic> itemFix_Address_DistrictArea) async {
    bool result = false;
    await FirebaseFirestore.instance
        .collection(en_TablesName.Fix_Address_DistrictArea.name)
        .doc(docName)
        .set(itemFix_Address_DistrictArea)
        .then((val) {
      result = true;
    }).catchError((error) {
      print(error.toString());
  ...
  static Future<bool> fire_SetItem(String docName, Fix_Address_DistrictArea itemFix_Address_DistrictArea) async {
    bool result = false;
    await FirebaseFirestore.instance
        .collection(en_TablesName.Fix_Address_DistrictArea.name)
        .doc(docName)
        .set(itemFix_Address_DistrictArea.toMap())
        .then((val) {
      result = true;
    }).catchError((error) {
      print(error.toString());
  ...
  static Future fire_setListMaster_And_Details({
    ...
    required Fix_Address_DistrictArea itemFix_Address_DistrictArea,
    ...
    CollectionReference coll = FirebaseFirestore.instance.collection(en_TablesName.Fix_Address_DistrictArea.name);
    DocumentReference tablemasterDocref = coll.doc(insertdDocID);
    WriteBatch batch = FirebaseFirestore.instance.batch();
    // save Master
    batch.set(tablemasterDocref, itemFix_Address_DistrictArea.toMap());
  ...
  static Future fire_setListMaster({
    required List<Fix_Address_DistrictArea> lstFix_Address_DistrictArea,
  }) async {
    CollectionReference coll = FirebaseFirestore.instance.collection(en_TablesName.Fix_Address_DistrictArea.name);
    WriteBatch batch = FirebaseFirestore.instance.batch();
    lstFix_Address_DistrictArea.forEach((elm) {
...
//**************************** get ****************************
  ...
  static Future<Fix_Address_DistrictArea> fire_getItem(String docName) async {
    late Fix_Address_DistrictArea itemFix_Address_DistrictArea;
    try {
      var retValue = await FirebaseFirestore.instance.collection(en_TablesName.Fix_Address_DistrictArea.name).doc(docName).get();
      itemFix_Address_DistrictArea = Fix_Address_DistrictArea();
      itemFix_Address_DistrictArea.ID = retValue.data()!['ID'];
      itemFix_Address_DistrictArea.Name = retValue.data()!['Name'];
      itemFix_Address_DistrictArea.CityID = retValue.data()!['CityID'];
      return itemFix_Address_DistrictArea;
    } catch (error) {
      print(error.toString());
      throw error;
    }
  ...
  static Future<List<Fix_Address_DistrictArea>> fire_getList() async {
    await FirebaseFirestore.instance.collection(en_TablesName.Fix_Address_DistrictArea.name).get().then((value) {
      lstFix_Address_DistrictArea.clear();
      value.docs.forEach((element) {
        lstFix_Address_DistrictArea.add(Fix_Address_DistrictArea.fromJson(element.data()));
      });
    }).catchError((error) {
      print(error.toString());
      throw error;
    });
    return lstFix_Address_DistrictArea;
  }

  static Future<List<Fix_Address_DistrictArea>> fire_getListByBranch(int branchID, String BranchColumnName) async {
    await FirebaseFirestore.instance
        .collection(en_TablesName.Fix_Address_DistrictArea.name)
  ...
  static Future<List<Fix_Address_DistrictArea>> fire_getListWithConditions({List<BLLCondions>? conditions}) async {
    CollectionReference colRef = FirebaseFirestore.instance.collection(en_TablesName.Fix_Address_DistrictArea.name);
    Query query = colRef;
    if (conditions != null) {
    ...
    snap.docs.forEach((element) {
      lstFix_Address_DistrictArea.add(Fix_Address_DistrictArea.fromJson(element.data() as Map<String, dynamic>));
    });
    return lstFix_Address_DistrictArea;
  }
...
//**************************** delete ****************************
  ...
  static Future<bool> fire_DeleteItem(String docName) async {
    bool result = false;
    await FirebaseFirestore.instance.collection(en_TablesName.Fix_Address_DistrictArea.name).doc(docName).delete().then((val) {
      result = true;
    }).catchError((error) {
      print(error.toString());
      result = false;
...
//**************************** Upload Files ****************************
  ...
  static Future<String> storage_UploadFile(String fileName, File file, {String pathOnStorage = ''}) async {
    pathOnStorage = pathOnStorage.isEmpty ? en_TablesName.Fix_Address_DistrictArea.name : pathOnStorage;
  ...
  static Future<String> storage_GetFileDowenloadURL(String fileName) async {
    ...
    await firebase_storage.FirebaseStorage.instance
        .ref()
        .child('${en_TablesName.Fix_Address_DistrictArea.name}/${fileName}')
        .getDownloadURL()
        .then((URL) {
      fileDownloadURL = URL;
    }).catchError((error) {
