...
static Future<Def_Categories> fire_getItem(String docName) async {
	...
	try { var retValue = await FirebaseFirestore.instance.collection(en_TablesName.Def_Categories.name).doc(docName).get();
	 itemDef_Categories = Def_Categories();
 itemDef_Categories.ID = retValue.data()!['ID']; itemDef_Categories.Name = retValue.data()!['Name']; itemDef_Categories.IsActive = retValue.data()!['IsActive']; itemDef_Categories.IsSalesCategory = retValue.data()!['IsSalesCategory']; itemDef_Categories.IsViewAllProducts = retValue.data()!['IsViewAllProducts'];	return  itemDef_Categories;
	} catch (error) {
	print(error.toString()); throw error;
	}
}
...
static Future<List<Def_Categories>> fire_getListByBranch(int branchID , String BranchColumnName) async {
	await FirebaseFirestore.instance.collection(en_TablesName.Def_Categories.name)
	.where(BranchColumnName, isEqualTo: branchID).get()
	.then((value) {lstDef_Categories.clear();value.docs.forEach((element) {
	lstDef_Categories.add(Def_Categories.fromJson(element.data()));});
