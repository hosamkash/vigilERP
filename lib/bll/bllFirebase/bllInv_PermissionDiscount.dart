...
//**************************** add & set ****************************
  ...
  static Future<bool> fire_SetItem(String docName, Inv_PermissionDiscount itemInv_PermissionDiscount) async {
    ...
    await FirebaseFirestore.instance
        .collection(en_TablesName.Inv_PermissionDiscount.name)
        .doc(docName)
        .set(itemInv_PermissionDiscount.toMap())
        .then((val) {
      result = true;
    }).catchError((error) {
      print(error.toString());
...
//**************************** get ****************************
  ...
  static Future<Inv_PermissionDiscount> fire_getItem(String docName) async {
    ...
    try {
      var retValue = await FirebaseFirestore.instance.collection(en_TablesName.Inv_PermissionDiscount.name).doc(docName).get();
      itemInv_PermissionDiscount = Inv_PermissionDiscount();
      itemInv_PermissionDiscount.ID = retValue.data()!['ID'];
      itemInv_PermissionDiscount.IDBranch = retValue.data()!['IDBranch'];
      itemInv_PermissionDiscount.Code = retValue.data()!['Code'];
      itemInv_PermissionDiscount.Date = retValue.data()!['Date'];
      itemInv_PermissionDiscount.Time = retValue.data()!['Time'];
      itemInv_PermissionDiscount.IDStock = retValue.data()!['IDStock'];
      itemInv_PermissionDiscount.IDEmployee = retValue.data()!['IDEmployee'];
      itemInv_PermissionDiscount.IDRequestStatus = retValue.data()!['IDRequestStatus'];
      itemInv_PermissionDiscount.Note = retValue.data()!['Note'];
      itemInv_PermissionDiscount.Value = retValue.data()!['Value'];
      itemInv_PermissionDiscount.UID = retValue.data()!['UID'];
      return itemInv_PermissionDiscount;
    } catch (error) {
      print(error.toString());
      throw error;
    }
  ...
  static Future<List<Inv_PermissionDiscount>> fire_getList() async {
    await FirebaseFirestore.instance.collection(en_TablesName.Inv_PermissionDiscount.name).get().then((value) {
...
//**************************** Upload Files ****************************
  ...
  static Future<String> storage_GetFileDowenloadURL(String fileName) async {
    ...
    await firebase_storage.FirebaseStorage.instance
        .ref()
        .child('${en_TablesName.Inv_PermissionDiscount.name}/${fileName}')
        .getDownloadURL()
        .then((URL) {
      fileDownloadURL = URL;
    }).catchError((error) {
