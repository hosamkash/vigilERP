import '../classModel/HR_Bonus.dart';
import 'dart:io';
...
class bllHR_Bonus {
  ...
  static late List<HR_Bonus> lstHR_Bonus = [];
  static late HR_Bonus itemHR_Bonus;
  static String query = '';
...
//**************************** general function ****************************
  ...
  static Future<int> getMaxID_firestore() async {
    ...
    await FirebaseFirestore.instance
        .collection(en_TablesName.HR_Bonus.name)
        .orderBy(enTable_HR_Bonus.ID.name, descending: true)
        .limit(1)
        .get()
        .then((value) {
      if (value.docs.isEmpty) {
        ...
        maxID = value.docs.first.get(enTable_HR_Bonus.ID.name);
        maxID += 1;
      }
    }).catchError((error) {
  ...
  static Future<int> getMax_firestore(enTable_HR_Bonus colName, {BLLCondions? condion}) async {
    int maxID = 1;
    ...
    try {
      if (condion != null) {
        ...
        snapshot = await FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name).orderBy(colName.name, descending: true).limit(1).get();
      }
...
//**************************** add & set ****************************
  ...
  static Future<String> fire_AddItem(HR_Bonus itemHR_Bonus) async {
    String docCreatedName = '';
    await FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name).add(itemHR_Bonus.toMap()).then((val) {
  ...
  static Future<bool> fire_SetItemMap(String docName, Map<String, dynamic> itemHR_Bonus) async {
    bool result = false;
    await FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name).doc(docName).set(itemHR_Bonus).then((val) {
      result = true;
    }).catchError((error) {
      print(error.toString());
      throw error;
  ...
  static Future<bool> fire_SetItem(String docName, HR_Bonus itemHR_Bonus) async {
    bool result = false;
    await FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name).doc(docName).set(itemHR_Bonus.toMap()).then((val) {
      result = true;
    }).catchError((error) {
      print(error.toString());
      throw error;
  ...
  static Future fire_setListMaster_And_Details({
    ...
    required HR_Bonus itemHR_Bonus,
    ...
    CollectionReference coll = FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name);
    DocumentReference tablemasterDocref = coll.doc(insertdDocID);
    WriteBatch batch = FirebaseFirestore.instance.batch();
    // save Master
    batch.set(tablemasterDocref, itemHR_Bonus.toMap());
  ...
  static Future fire_setListMaster({
    required List<HR_Bonus> lstHR_Bonus,
  }) async {
    CollectionReference coll = FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name);
    WriteBatch batch = FirebaseFirestore.instance.batch();
    lstHR_Bonus.forEach((elm) {
...
//**************************** get ****************************
  ...
  static Future<HR_Bonus> fire_getItem(String docName) async {
    late HR_Bonus itemHR_Bonus;
    try {
      var retValue = await FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name).doc(docName).get();
      itemHR_Bonus = HR_Bonus();
      itemHR_Bonus.ID = retValue.data()!['ID'];
      itemHR_Bonus.IDBranch = retValue.data()!['IDBranch'];
      itemHR_Bonus.Code = retValue.data()!['Code'];
      itemHR_Bonus.Date = retValue.data()!['Date'];
      itemHR_Bonus.Time = retValue.data()!['Time'];
      itemHR_Bonus.IDEmployee = retValue.data()!['IDEmployee'];
      itemHR_Bonus.IDJob = retValue.data()!['IDJob'];
      itemHR_Bonus.IDDepartment = retValue.data()!['IDDepartment'];
      itemHR_Bonus.EmployeeSalaryMonth = retValue.data()!['EmployeeSalaryMonth'];
      itemHR_Bonus.EmployeeSalaryWeek = retValue.data()!['EmployeeSalaryWeek'];
      itemHR_Bonus.EmployeeSalaryDay = retValue.data()!['EmployeeSalaryDay'];
      itemHR_Bonus.EmployeeSalaryHour = retValue.data()!['EmployeeSalaryHour'];
      itemHR_Bonus.BounsType = retValue.data()!['BounsType'];
      itemHR_Bonus.BounsDays = retValue.data()!['BounsDays'];
      itemHR_Bonus.BounsValue = retValue.data()!['BounsValue'];
      itemHR_Bonus.BounsReson = retValue.data()!['BounsReson'];
      itemHR_Bonus.IDCalcSalary = retValue.data()!['IDCalcSalary'];
      itemHR_Bonus.UID = retValue.data()!['UID'];
      itemHR_Bonus.IsClosed = retValue.data()!['IsClosed'];
      return itemHR_Bonus;
    } catch (error) {
      print(error.toString());
      throw error;
  ...
  static Future<List<HR_Bonus>> fire_getList() async {
    await FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name).get().then((value) {
      lstHR_Bonus.clear();
      value.docs.forEach((element) {
        lstHR_Bonus.add(HR_Bonus.fromJson(element.data()));
      });
    }).catchError((error) {
      print(error.toString());
      throw error;
  ...
  static Future<List<HR_Bonus>> fire_getListByBranch(int branchID, String BranchColumnName) async {
    await FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name).where(BranchColumnName, isEqualTo: branchID).get().then((value) {
      lstHR_Bonus.clear();
      value.docs.forEach((element) {
        lstHR_Bonus.add(HR_Bonus.fromJson(element.data()));
      });
  ...
  static Future<List<HR_Bonus>> fire_getListWithConditions({List<BLLCondions>? conditions}) async {
    CollectionReference colRef = FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name);
    Query query = colRef;
    if (conditions != null) {
    ...
    snap.docs.forEach((element) {
      lstHR_Bonus.add(HR_Bonus.fromJson(element.data() as Map<String, dynamic>));
    });
    return lstHR_Bonus;
  }
...
//**************************** delete ****************************
  ...
  static Future<bool> fire_DeleteItem(String docName) async {
    bool result = false;
    await FirebaseFirestore.instance.collection(en_TablesName.HR_Bonus.name).doc(docName).delete().then((val) {
      result = true;
    }).catchError((error) {
      print(error.toString());
      result = false;
...
//**************************** Upload Files ****************************
  ...
  static Future<String> storage_UploadFile(String fileName, File file, {String pathOnStorage = ''}) async {
    pathOnStorage = pathOnStorage.isEmpty ? en_TablesName.HR_Bonus.name : pathOnStorage;
  ...
  static Future<String> storage_GetFileDowenloadURL(String fileName) async {
    String fileDownloadURL = '';
    await firebase_storage.FirebaseStorage.instance.ref().child('${en_TablesName.HR_Bonus.name}/${fileName}').getDownloadURL().then((URL) {
      fileDownloadURL = URL;
    }).catchError((error) {
      print(error.toString());
      throw error;
