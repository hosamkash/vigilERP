...
//**************************** get ****************************
  ...
  static Future<Def_FinancialCluses> fire_getItem(String docName) async {
    ...
    try {
      var retValue = await FirebaseFirestore.instance.collection(en_TablesName.Def_FinancialCluses.name).doc(docName).get();
      itemDef_FinancialCluses = Def_FinancialCluses();
      itemDef_FinancialCluses.ID = retValue.data()!['ID'];
      itemDef_FinancialCluses.Code = retValue.data()!['Code'];
      itemDef_FinancialCluses.Name = retValue.data()!['Name'];
      itemDef_FinancialCluses.IsViewToRepresent = retValue.data()!['IsViewToRepresent'];
      itemDef_FinancialCluses.IDFinancialType = retValue.data()!['IDFinancialType'];
      itemDef_FinancialCluses.IsDefaultToTransferMony = retValue.data()!['IsDefaultToTransferMony'];
      itemDef_FinancialCluses.IsActive = retValue.data()!['IsActive'];
      return itemDef_FinancialCluses;
    } catch (error) {
      print(error.toString());
      throw error;
    }
  ...
  static Future<List<Def_FinancialCluses>> fire_getList() async {
    await FirebaseFirestore.instance.collection(en_TablesName.Def_FinancialCluses.name).get().then((value) {
