...
static Future<Dealing_Clients> fire_getItem(String docName) async {
	...
	try { var retValue = await FirebaseFirestore.instance.collection(en_TablesName.Dealing_Clients.name).doc(docName).get();
	 itemDealing_Clients = Dealing_Clients();
 itemDealing_Clients.ID = retValue.data()!['ID']; itemDealing_Clients.IDBranch = retValue.data()!['IDBranch']; itemDealing_Clients.Code = retValue.data()!['Code']; itemDealing_Clients.Name = retValue.data()!['Name']; itemDealing_Clients.IsActive = retValue.data()!['IsActive']; itemDealing_Clients.CurrentBalance = retValue.data()!['CurrentBalance']; itemDealing_Clients.BalanceType = retValue.data()!['BalanceType']; itemDealing_Clients.Mobile = retValue.data()!['Mobile']; itemDealing_Clients.Phone = retValue.data()!['Phone']; itemDealing_Clients.Address = retValue.data()!['Address']; itemDealing_Clients.Note = retValue.data()!['Note']; itemDealing_Clients.IDPriceType = retValue.data()!['IDPriceType']; itemDealing_Clients.CreditLimit = retValue.data()!['CreditLimit']; itemDealing_Clients.LocationLink = retValue.data()!['LocationLink']; itemDealing_Clients.LocationLatitude = retValue.data()!['LocationLatitude']; itemDealing_Clients.LocationLongitude = retValue.data()!['LocationLongitude']; itemDealing_Clients.LocationImage = retValue.data()!['LocationImage'];	return  itemDealing_Clients;
	} catch (error) {
	print(error.toString()); throw error;
	}
}
...
static Future<List<Dealing_Clients>> fire_getListByBranch(int branchID , String BranchColumnName) async {
	await FirebaseFirestore.instance.collection(en_TablesName.Dealing_Clients.name)
	.where(BranchColumnName, isEqualTo: branchID).get()
	.then((value) {lstDealing_Clients.clear();value.docs.forEach((element) {
	lstDealing_Clients.add(Dealing_Clients.fromJson(element.data()));});
