  ...
  static Future<int> getMax_firestore(enTable_Fina_Exchange colName, {BLLCondions? condion}) async {
    ...
    try {
      if (condion != null) {
        ...
        snapshot =
            await FirebaseFirestore.instance.collection(en_TablesName.Fina_Exchange.name).orderBy(colName.name, descending: true).limit(1).get();
      }
...
//**************************** get ****************************
  ...
  static Future<Fina_Exchange> fire_getItem(String docName) async {
    ...
    try {
      var retValue = await FirebaseFirestore.instance.collection(en_TablesName.Fina_Exchange.name).doc(docName).get();
      itemFina_Exchange = Fina_Exchange();
      itemFina_Exchange.ID = retValue.data()!['ID'];
      itemFina_Exchange.Code = retValue.data()!['Code'];
      itemFina_Exchange.Serial = retValue.data()!['Serial'];
      itemFina_Exchange.Date = retValue.data()!['Date'];
      itemFina_Exchange.Time = retValue.data()!['Time'];
      itemFina_Exchange.IDTreasur = retValue.data()!['IDTreasur'];
      itemFina_Exchange.DealingTypeID = retValue.data()!['DealingTypeID'];
      itemFina_Exchange.DealingID = retValue.data()!['DealingID'];
      itemFina_Exchange.BalanceBefor = retValue.data()!['BalanceBefor'];
      itemFina_Exchange.Value = retValue.data()!['Value'];
      itemFina_Exchange.BalanceAfter = retValue.data()!['BalanceAfter'];
      itemFina_Exchange.IDFinancialType = retValue.data()!['IDFinancialType'];
      itemFina_Exchange.IDFinancialCluses = retValue.data()!['IDFinancialCluses'];
      itemFina_Exchange.Note = retValue.data()!['Note'];
      itemFina_Exchange.IsBindeDocument = retValue.data()!['IsBindeDocument'];
      itemFina_Exchange.BindeDocumentTypeID = retValue.data()!['BindeDocumentTypeID'];
      itemFina_Exchange.BindeDocumentID = retValue.data()!['BindeDocumentID'];
      itemFina_Exchange.BindeDocumentText = retValue.data()!['BindeDocumentText'];
      itemFina_Exchange.BindeDocumentCode = retValue.data()!['BindeDocumentCode'];
      itemFina_Exchange.IsAccountedByRepresent = retValue.data()!['IsAccountedByRepresent'];
      itemFina_Exchange.IDUser = retValue.data()!['IDUser'];
      itemFina_Exchange.IDBranch = retValue.data()!['IDBranch'];
      itemFina_Exchange.IsClosedTreasure = retValue.data()!['IsClosedTreasure'];
      itemFina_Exchange.IDClosedTreasure = retValue.data()!['IDClosedTreasure'];
      itemFina_Exchange.IsClosedEdit = retValue.data()!['IsClosedEdit'];
      itemFina_Exchange.IDCalcSalary = retValue.data()!['IDCalcSalary'];
      return itemFina_Exchange;
    } catch (error) {
      print(error.toString());
      throw error;
    }
  ...
  static Future<List<Fina_Exchange>> fire_getList() async {
    await FirebaseFirestore.instance.collection(en_TablesName.Fina_Exchange.name).get().then((value) {
  ...
  static Future<List<Fina_Exchange>> fire_getListByBranch(int branchID, String BranchColumnName) async {
    await FirebaseFirestore.instance.collection(en_TablesName.Fina_Exchange.name).where(BranchColumnName, isEqualTo: branchID).get().then((value) {
      lstFina_Exchange.clear();
      value.docs.forEach((element) {
        lstFina_Exchange.add(Fina_Exchange.fromJson(element.data()));
      });
